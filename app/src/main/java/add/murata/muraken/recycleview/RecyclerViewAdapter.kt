...
class RecyclerViewAdapter(private val context: Context):RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.charaImage.setImageResource(item.characterImageResourse)
        holder.charaNameTextView.text = item.courseName
        holder.charaDatailTextView.text = item.decription
    }
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view){
        ...
        val charaNameTextView: TextView = view.findViewById(R.id.couurseNameTextView)
